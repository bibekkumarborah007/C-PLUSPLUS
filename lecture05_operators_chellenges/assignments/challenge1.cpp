// Challenege 1
// Write a program that calculate the price of tea packs. A user enters the number of tea packs they want, and the price per pack. Apply a 10% tax to the total and display the final cost.
