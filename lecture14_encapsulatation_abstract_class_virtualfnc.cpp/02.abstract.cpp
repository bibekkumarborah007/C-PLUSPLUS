...
{
public:
    virtual void prepareIngrediants() = 0; // pure virtual function syntax: a abstract class inside no details but moti moti baat likhi hai no implmentation but boiler plate
    virtual void brew() = 0;
